        ...
        <div id="status">
            ...
            <form action="{{ route('acc.account_801_dash') }}" method="GET">
                ...
                <div class="row"> 
                    <div class="col"></div>
                    <div class="col-md-7">
                        <h4 class="card-title" style="color:green">Detail 1102050102.801</h4>
                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap myTable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="background-color: rgb(135, 190, 253)">Statment</th>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="{{url('account_801_pull')}}" target="_blank" style="color:rgb(5, 58, 173);"> {{ number_format($sum_N, 2) }}</a>
                                                    </td>                                                    
                                                    <td class="text-end" style="color:rgb(231, 73, 139);background-color: rgb(203, 227, 255)" width="10%"> 
                                                        <a href="{{url('account_801_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(231, 73, 139);"> {{ number_format($total_sumY, 2) }}</a> 
                                                    </td> 
                                                    <td class="text-end" style="color:rgb(2, 116, 63);background-color: rgb(203, 227, 255)" width="10%"> 
                                                         <a href="{{url('account_801_stm/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(2, 116, 63);"> {{ number_format($sum_stm_money, 2) }}</a> 
                                                    </td> 
                                                  
                                                    <td class="text-end" style="color:rgb(224, 128, 17)" width="10%">  
                                                        <a href="{{url('account_801_yokpai/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(224, 128, 17);"> {{ number_format($sum_yokpai, 2) }}</a> 
                                                    </td>
                                                </tr>
                                            <?php
