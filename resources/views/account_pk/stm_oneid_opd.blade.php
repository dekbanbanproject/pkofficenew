            ...
            <div class="col-xl-8 col-md-6">
                <div class="card card_audit_4c">
                    <div class="grid-menu-col">
                        <form method="POST" action="{{ route('acc.stm_oneid_opdsave') }}" enctype="multipart/form-data"> 
                            @csrf
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8">
                                    <div class="mb-3 mt-3">
                                        <label for="file" class="form-label">UP STM ONEID EXCEL => UP STM => ส่งข้อมูล</label>
                                        <input class="form-control form-control-lg" id="file_stm" name="file_stm" type="file" required>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    </div>
                                    @if ($countc > 0)
                                        <a href="{{ url('stm_oneid_opdsend') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary">
