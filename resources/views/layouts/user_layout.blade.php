                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{ url('user/home') }}" id="topnav-apps" role="button">
                                    <i class="fa-solid fa-chart-pie me-2" style="font-size: 20px;color:rgb(4, 194, 169)"></i>Dashboard  
                                </a>                               
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button"
                                >
                                    <i class="fa-solid fa-user-check me-2" style="font-size: 20px;color:rgb(247, 46, 146)"></i>งานบริหารทั่วไป
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item" href="#" id="topnav-email">
                                            <i class="fa-solid fa-paintbrush me-2" style="font-size: 20px;color:rgb(255, 99, 177)"></i>งานโสตทัศนูปกรณ์  <div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item" href="#" id="topnav-email">
                                            <i class="fas fa-desktop me-2" style="font-size: 20px;color:rgb(255, 99, 177)"></i>แจ้งซ่อมคอมพิวเตอร์  <div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-email">
