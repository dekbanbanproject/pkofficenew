...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <div class="row"> 
            <div class="col text-center"> 
                <h4 style="color:rgb(255, 255, 255)">ตรวจสอบไนตรัสออกไซด์ (N2O-6Q)</h4>   
            </div>
                    ...
                    <div class="card-body"> 
                                    ...
                                    <table id="Tabledit" class="table table-bordered border-info table-hover table-sm" style="border-collapse: collapse;border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr style="font-size: 13px">                                        
                                                ...
                                                <th class="text-center" style="background: #e4fdfc">ตัวถัง</th>  
                        ...
                        <div class="row mt-4 mb-4">
                            ...
                            <div class="col text-center">
                                ...
                                <a href="{{url('gas_check_nitrus')}}" class="ladda-button me-2 btn-pill btn btn-warning bt_prs">  
    ...
    <script>
        $(document).ready(function() {
            $('#Tabledit').Tabledit({
                url:'{{route("prs.gas_check_nitrus_save")}}',
                dataType:"json",
                // editButton: true,
                removeButton: false,
                columns:{
                    ...
                    // editable: [[3, 'gas_check_body', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}'], [4, 'gas_check_valve', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}'], [5, 'gas_check_pressure', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}'],[6, 'active', '{"Ready":"พร้อมใช้", "NotReady":"ไม่พร้อมใช้", "Wait":"รอเติม", "Borrow":"ยืมคืน"}']]
                    editable: [[3, 'gas_check_body', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}'], [4, 'gas_check_valve', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}'], [5, 'gas_check_pressure', '{"0":"พร้อมใช้", "1":"ไม่พร้อมใช้"}']]
                },
                // restoreButton:false,
                deleteButton: false,
                // saveButton: false,
